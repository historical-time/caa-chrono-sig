...
We would like to personally invite you to contribute to an (online only) Archaeometry Special Issue on the subject of '*Chronology: formal methods and research software*'. We were very intrigued by ${inv.papers.df[i, 'topic']}. We were wondering if you would consider a paper on this topic? If you are interested in taking up this invitation, please **let us know by the ${inv.papers.df[i, 'Formal.response']}**.  
