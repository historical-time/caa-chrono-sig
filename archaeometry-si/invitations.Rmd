...
We would like to personally invite you to contribute to an (online only) peer-reviewed special Issue of the Archaeometry journal, on the subject of '*Chronology: formal methods and research software*'. We were very intrigued by ${inv.papers.df[i, 'topic']}. We were wondering if you would consider a paper on this topic? If you are interested in taking up this invitation, please **let us know by ${inv.papers.df[i, 'Formal.response']}**. If you are unable to undertake this project personally but know someone who might, we would appreciate if you could provide us with their name and contact information. We would also be grateful if you would agree to act as a reviewer for at least one paper in this special issue. 
